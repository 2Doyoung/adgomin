package com.adin.common;

public class CategoryPaging {

    private int totalCount; // 게시판 전체 데이터 개수
    private int displayPageNum = 24; // 게시판 화면에서 한번에 보여질 페이지 번호의 개수
    ...
    public CategoryCriteria getCri() {
        return cri;
    }
 
    public void setCri(CategoryCriteria cri) {
        this.cri = cri;
    }
