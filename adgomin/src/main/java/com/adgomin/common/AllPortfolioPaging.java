package com.adgomin.common;

public class AllPortfolioPaging {
    ...
    private AllPortfolioCriteria cri;
    ...
    public AllPortfolioCriteria getCri() {
        return cri;
    }
 
    public void setCri(AllPortfolioCriteria cri) {
        this.cri = cri;
    }
